                ...
                <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                    <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                            <h1 class="text-6xl font-extrabold tracking-tight text-gray-900 sm:text-9xl">Green Spheres</h1>
                            <br><br>
                            <h2 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-6xl">La justice sociale et environnementale au cœur des entreprises.</h2>
                            <p class="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">Riche d’une expertise pluridisciplinaire, notre équipe vous accompagne de la fondation de votre stratégie RSE jusqu’à ses résultats.</p>
                            <div class="mt-10 flex items-center gap-x-6">
                                <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Demander un devis</a>
                                <a href="/contact" class="text-sm font-semibold leading-6 text-gray-900">Nous contacter<span aria-hidden="true">→</span></a>
                            </div>
                        </div>
...
<div class="relative isolate overflow-hidden bg-green-800">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Notre mission</h1>
            <p class="mt-6 text-lg leading-8 text-gray-300">Soutenir toutes les entreprises dans la mise en place de leur politique RSE avec une offre adaptée à la taille de chaque société.</p>
        </div>
    </div>
</div>
