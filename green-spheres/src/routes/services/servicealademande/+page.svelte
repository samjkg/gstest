    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div class="w-full lg:max-w-lg lg:flex-auto">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Nos services complémentaires</h2>
                <p class="mt-6 text-xl leading-8 text-gray-600">Les offres présentées ne correspondent pas  exactement à vos besoins? Pas de problème ! Vous pouvez ici composer votre service sur mesure.</p>
                    ...
                    <li class="py-8">
                        <dl class="relative flex flex-wrap gap-x-3">
                            ...
                            <dd class="w-full flex-none text-lg font-semibold tracking-tight text-gray-900">
                                <i class="fa-regular fa-circle-check"></i>
                                <a href="#">
                                    Organisation de voyage d’affaires éco-responsables
                                    <span class="absolute inset-0" aria-hidden="true"></span>
                                </a>
                            </dd>
                        </dl>
                    ...
                    <li class="py-8">
                        <dl class="relative flex flex-wrap gap-x-3">
                            ...
                            <dd class="w-full flex-none text-lg font-semibold tracking-tight text-gray-900">
                                <i class="fa-regular fa-circle-check"></i>
                                <a href="#">
                                    Rédaction d’une charte d’achats responsables
                                    <span class="absolute inset-0" aria-hidden="true"></span>
                                </a>
                            </dd>
                        </dl>
                    ...
                    <li class="py-8">
                        <dl class="relative flex flex-wrap gap-x-3">
                            ...
                            <dd class="w-full flex-none text-lg font-semibold tracking-tight text-gray-900">
                                <i class="fa-regular fa-circle-check"></i>
                                <a href="#">
                                    Organisation de fresque du climat
                                    <span class="absolute inset-0" aria-hidden="true"></span>
                                </a>
                            </dd>
                        </dl>
